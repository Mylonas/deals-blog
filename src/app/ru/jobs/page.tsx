...
export const metadata = {
  ...
  description:
    "Все открытые вакансии государственного сектора Кипра в одном месте: госслужба (ΕΔΥ), полугосударственные организации, пять районных организаций самоуправления и все 20 муниципалитетов.",
};
  ...
  return (
    <article className="max-w-3xl">
      ...
      <p className="text-gray-500 dark:text-gray-400 mb-8">
        Все открытые вакансии государственного сектора Кипра из 43 официальных
        источников: конкурсы госслужбы (ΕΔΥ), полугосударственные организации
        (Cyta, ΑΗΚ, Управление портов, ΟΚΥπΥ, университеты), пять районных
        организаций самоуправления и все 20 муниципалитетов. Сроки подачи заявок
        считываются из самих объявлений. Последнее обновление{" "}
